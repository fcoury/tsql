...
const COMMANDS: HelpSection = HelpSection::new(
    ...
    &[
        ...
        KeyBinding::new(":write-mode <mode>", "Set generated write safety mode"),
        KeyBinding::new(":commit / :rollback", "Finish generated write transaction"),
        KeyBinding::new(":changes", "Show generated transaction writes"),
